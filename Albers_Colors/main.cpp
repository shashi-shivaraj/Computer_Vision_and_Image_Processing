...
void DisplayNoHelp() {
  unsigned char leftColor[3], rightColor[3], leftshapeColor[3],rightshapeColor[3];
...
void Menu( int item )
{
  switch ( item ) {
    ...
    case MODE_COLOR:
      ...
      sprintf ( helpText[3], "Press 1 to edit left, 2 for right, 3 for left center,4 for right center" );
...
void CreateMenu()
{
  ...
  glutAddMenuEntry ( "[3] Edit Left Shape Color", CMD_EDIT_LEFT_SHAPE_COLOR );
  glutAddMenuEntry ( "[4] Edit Right Shape Color", CMD_EDIT_RIGHT_SHAPE_COLOR );
